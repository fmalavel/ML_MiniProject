...
def build_mlp_ozone_forecaster(nlat, nlon, n_channels, config=None):
    """Build a pixel-independent MLP ozone forecaster."""
    ...
    # Each pixel is treated independently; weights are shared across pixels.
    x = tf.keras.layers.Reshape((nlat * nlon, n_channels))(inputs)
